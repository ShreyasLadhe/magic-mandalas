                        ...
                        <div className="mt-2.5 flex items-center justify-between">
                          ...
                          <div className="inline-flex items-center overflow-hidden rounded-full border border-[#e8e0d5] bg-[#faf8f5]">
                            <button
                              ...
                              className="flex h-7 w-7 items-center justify-center text-muted transition hover:bg-[#f5ede5] hover:text-[#b05c34]"
                            >
                              <Minus size={12} strokeWidth={2.5} />
                            </button>
                            <span className="min-w-[1.75rem] text-center text-xs font-semibold tabular-nums text-primary">
                              {line.quantity}
                            </span>
                            <button
                              type="button"
